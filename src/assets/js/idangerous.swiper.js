...
var Swiper = function (selector, params) {
    ...
    function onTouchEnd(event) {
        ...
        if (params.freeMode) {
            if (params.freeModeFluid) {
                var momentumDuration = 3000 * params.momentumRatio;
    ...
    function swipeToPosition(newPosition, action, toOptions) {
        ...
        function anim() {
            ...
            currentPosition += animationStep * time / (3000 / 60);
        ...
        if (_this.support.transitions || !params.DOMAnimation) {
            ...
            var currentPosition = _this.getWrapperTranslate();
            var animationStep = Math.ceil((newPosition - currentPosition) / speed * (3000 / 60));
...
Swiper.prototype = {
    ...
    setWrapperTransition : function (duration) {
        'use strict';
        var es = this.wrapper.style;
        es.webkitTransitionDuration = es.MsTransitionDuration = es.msTransitionDuration = es.MozTransitionDuration = es.OTransitionDuration = es.transitionDuration = (duration / 3000) + 's';
